...
sub usage
{
    print STDERR ("Usage: pressmintp-tei2meta.pl -jobs <Jobs> -root <corpusRoot> -out <OutputDirectory>\n");
    print STDERR ("       Converts PressMint component files in the <corpusRoot> to\n");
...
# For orig corpora make PressMint-XX-meta.tsv in corpus language and PressMint-XX-meta-en.tsv in English
# For MTed corpora we produce PressMint-XX-en-meta.tsv in English
