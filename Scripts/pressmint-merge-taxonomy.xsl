<?xml version="1.0"?>
<!-- Insert translations of corpus-specific taxonomies into the PressMint-wide template taxonomy -->
<!-- Input it PressMint overall corpus root file, the XIncludes of which are followed until finding and gathering corpus-specific taxonomies -->
