...
<xsl:stylesheet 
  ...
  <xsl:import href="pressamint-lib.xsl"/>
  ...
  <!-- DK specific topic -->
  <!-- E.g. 
       <u who="#HaarderBertel" xml:id="PressMint-DK_20141007120002" ana="#chair #domain.other">
       + 
       <taxonomy xmlns="http://www.tei-c.org/ns/1.0" xml:id="PressMint-DK-taxonomy-domains" xml:lang="mul">
       <desc xml:lang="en"><term>Policy domains</term> in the PressMint-DK corpus</desc>
       <desc xml:lang="da"><term>Politiske emneområder</term> i PressMint-DK</desc>
       ...
       etc.
       = (dk):
       <speech id="PressMint-DK_20141007120002" ... topic="Folketingsanliggender">
  -->
